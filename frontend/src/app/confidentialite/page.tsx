export default function ConfidentialitePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 min-w-0 w-full">
      <h1 className="text-2xl font-heading text-secondary mb-6">Politique de confidentialité</h1>

      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">1. Données collectées</h2>
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">2. Protection des données</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">3. Utilisation des données</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">4. Paiement</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">5. Cookies</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section>
        <h2 className="font-heading text-secondary text-lg mb-2">6. Droits de l&apos;utilisateur</h2>
        <p className="text-sm text-text-dark leading-relaxed">
