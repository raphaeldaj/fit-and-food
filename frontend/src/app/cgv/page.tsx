export default function CGVPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 min-w-0 w-full">
      <h1 className="text-2xl font-heading text-secondary mb-6">Conditions Générales de Vente</h1>

      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">1. Objet</h2>
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">2. Souscription et composition du pack</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">3. Prix et paiement</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">4. Reconduction et cycles de livraison</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">5. Suspension et annulation</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section>
        <h2 className="font-heading text-secondary text-lg mb-2">6. Livraison</h2>
        <p className="text-sm text-text-dark leading-relaxed">
