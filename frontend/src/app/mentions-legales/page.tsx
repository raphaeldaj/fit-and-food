export default function MentionsLegalesPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 min-w-0 w-full">
      <h1 className="text-2xl font-heading text-secondary mb-6">Mentions légales</h1>

      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">Éditeur du site</h2>
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">Hébergement</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-secondary text-lg mb-2">Paiement</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section>
        <h2 className="font-heading text-secondary text-lg mb-2">Propriété intellectuelle</h2>
        <p className="text-sm text-text-dark leading-relaxed">
