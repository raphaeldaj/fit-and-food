export default function CGUPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 min-w-0 w-full">
      <h1 className="text-2xl font-heading text-primary mb-6">Conditions Générales d&apos;Utilisation</h1>

      <section className="mb-6">
        <h2 className="font-heading text-primary text-lg mb-2">1. Accès au site</h2>
      ...
      <section className="mb-6">
        <h2 className="font-heading text-primary text-lg mb-2">2. Compte utilisateur</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="font-heading text-primary text-lg mb-2">3. Utilisation autorisée</h2>
        <p className="text-sm text-text-dark leading-relaxed">
      ...
      <section>
        <h2 className="font-heading text-primary text-lg mb-2">4. Responsabilité</h2>
        <p className="text-sm text-text-dark leading-relaxed">
